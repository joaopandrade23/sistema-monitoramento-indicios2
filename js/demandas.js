...
function conectarIntegracaoFinal(){
  ...
  gx("tamanhoPaginaConcluidas").onchange=e=>{estado.concluidas.tamanho=Number(e.target.value);estado.concluidas.pagina=1;gconcluidas()};gx("concluidasAnteriorBtn").onclick=()=>{if(estado.concluidas.pagina>1){estado.concluidas.pagina--;gconcluidas()}};gx("concluidasProximaBtn").onclick=()=>{if(estado.concluidas.pagina<estado.concluidas.totalPaginas){estado.concluidas.pagina++;gconcluidas()}};
